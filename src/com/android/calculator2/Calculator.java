...
public class Calculator extends AppCompatActivity
    ...
    private void removeHistoryFragment() {
        final androidx.fragment.app.FragmentManager manager = getSupportFragmentManager();
        if (manager != null && !manager.isDestroyed()) {
            manager.popBackStack(HistoryFragment.TAG, androidx.fragment.app.FragmentManager.POP_BACK_STACK_INCLUSIVE);
        }
